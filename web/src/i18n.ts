...
const dict = {
  ...
  searchRooms: { en: "Search rooms…", es: "Buscar salas…" },
  filterAll: { en: "All", es: "Todas" },
  filterFriends: { en: "Friends", es: "Amigos" },
  filterPublic: { en: "Public", es: "Públicas" },
  filterPrivate: { en: "Private", es: "Privadas" },
  friendsPlaying: { en: "Friends playing", es: "Amigos jugando" },
  allRooms: { en: "All rooms", es: "Todas las salas" },
  ...
  connectionQuality: { en: "Connection quality", es: "Calidad de conexión" },
  bandwidthHigh: { en: "High (fast internet)", es: "Alta (internet rápido)" },
  bandwidthMedium: { en: "Medium", es: "Media" },
  bandwidthLow: { en: "Low (<20 Mbps)", es: "Baja (<20 Mbps)" },
  bandwidthHint: { en: "Choose Low if you or your friends have a slow or unstable connection — sharper drop in quality, much smoother play.", es: "Elegí Baja si vos o tus amigos tienen internet lento o inestable — baja más la calidad, pero juega mucho más fluido." },
